...
//import edu.casetools.icase.argumentation.RulesCompiler; imported from Argumentation
...
//import hybridsystem.HybridMain; //created class
...
//		New
		if(RulesCompiler.mainFile != null){
			File file = new File(RulesCompiler.mainFile);
			BufferedReader br;
			try {
...
//		New
		...
		{
			fileTextPane.getTextArea().setText(ss);
		}
		//EndNew
	...
	public void refreshMidPanel(){
		...
		midMidPanel.repaint();
		resultsScrollPane.getVerticalScrollBar().setValue(resultsScrollPane.getVerticalScrollBar().getMaximum());
	}
