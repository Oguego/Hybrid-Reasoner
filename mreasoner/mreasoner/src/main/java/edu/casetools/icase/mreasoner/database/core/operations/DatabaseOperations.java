...
//		public abstract ResultSet findLatestInternalEvents(long lastId);
		...
		public abstract ResultSet getActuators();
		public abstract ResultSet getSensorActuators(); //GINES
		public abstract boolean setOutsideActuatorResult(String state, String datetime, String value);

		public abstract ResultSet getSensors();
		public abstract ResultSet getSensorsName();
