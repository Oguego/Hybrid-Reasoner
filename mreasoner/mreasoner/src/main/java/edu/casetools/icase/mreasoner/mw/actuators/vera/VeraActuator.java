...
public class VeraActuator implements Actuator {
	...
	public VeraActuator(VeraConfigs configs){
	...
	public void performAction(Action action) {
	  ...
	  // String inputLine;
	        ...
	        System.out.println(timestamp + " ***** ACTUATOR MANAGER: SWITCHING " + configs.getState() + " " +action.getDevice()+" TO VALUE "+action.getValue());
